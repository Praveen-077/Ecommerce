...
const CheckOutPage = () => {
  return (
    <div className="mx-auto bg-gray-100 max-w-7xl px-4 py-6 sm:px-6 lg:px-8 mt-10">
      <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
        ...
        <div className="lg:col-span-2">
          <div className="mx-auto mt-0 bg-white max-w-7xl px-0  sm:px-0 lg:px-0 ">
            <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
              <h1 className="text-4xl border-gray-200 font-bold tracking-tight text-gray-900">
                Cart
              </h1>
              <div className="mt-8">
